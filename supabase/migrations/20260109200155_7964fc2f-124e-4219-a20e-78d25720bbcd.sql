-- Create table for Telegram notification subscriptions (PRO users only)
...
COMMENT ON TABLE public.telegram_subscriptions IS 'Stores Telegram bot subscriptions for PRO users to receive new listing notifications';