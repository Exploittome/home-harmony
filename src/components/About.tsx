...
const features = [{
  ...
  description: 'Оберіть план, який підходить саме вам: Базовий, План на 10 днів, План на 30 днів.'
}, {
  icon: Home,
  title: 'Широкий вибір',
      ...
      <div className="max-w-7xl mx-auto">
        <div ref={ref} className={`transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {features.map((feature, index) => <div key={feature.title} className="card-container-hover p-8" style={{
          ...
          <div className="mt-16 card-container p-8 md:p-12">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                <div className="font-display text-4xl md:text-5xl font-bold text-accent mb-2">1000+</div>
              ...
              <div>
                <div className="font-display text-4xl md:text-5xl font-bold text-accent mb-2">​Безліч</div>
