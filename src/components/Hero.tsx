        ...
        <div className="card-container p-4 md:p-8">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col justify-center py-4 md:py-8 md:px-4">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-md animate-slide-up" style={{ animationDelay: '0.1s' }}>
                ...
                <div className="flex items-center gap-3">
                  <div className="flex -space-x-2">
                    {[1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className="w-8 h-8 rounded-full bg-secondary border-2 border-card flex items-center justify-center text-xs text-muted-foreground"
                      >
                        {i}K
                      </div>
                    ))}
                  </div>
                  <span className="text-sm text-muted-foreground">активних оголошень</span>
                </div>
              </div>
            </div>
          </div>
